# 📚 DegreeTrack Community Library

Welcome to the **DegreeTrack Community Library**! This repository hosts user-created courses for [DegreeTrack](https://github.com/pandeysuryansh921-wq/course-tracker), an offline, local-first web application for self-learners.
...
Simply open your DegreeTrack application, go to **Settings > Import Course > Browse Community Library**, and click **Download & Enroll**. The app will automatically fetch the course from this repository and load it directly into your local database.

## 🤝 How to Contribute a Course

Want to share a course you've created with the community? It's easy!

1. Open the DegreeTrack app and go to **Settings > Export Course**.
...
5. Edit the `courses.json` file to add your course details to the list. Use this format:
   ...
   ```
6. Submit a **Pull Request**. Once approved, your course will instantly become available inside the DegreeTrack app for everyone!
